...
# Loop 22 is not valid: Edge 388 crosses edge 390
# fix ^^ by inserting "sf_use_s2(FALSE)" above
...
# Grizzly: peaks shift slightly away from day with higher human presence
# Whitetail: more nocturnal with higher human presence
# Overlap: Higher in areas of higher human disturbance (p < 0.01)