# Black Bear and Bobcat Overlap Analysis
# Margaret Mercer
# May 21, 2024
...
pdf("results/overlap_graphs/blackbear_bobcat_low.pdf")
...
pdf("results/overlap_graphs/blackbear_bobcat_high.pdf")
...
# t = 1.4928, df = 398, p-value = 0.1363
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.0007902252  0.0057765438
# sample estimates:
#   mean of x mean of y 
# 0.8309718 0.8284786 