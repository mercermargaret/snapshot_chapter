# Black Bear and Raccoon Overlap Analysis
# Margaret Mercer
# May 21, 2024
...
pdf("results/overlap_graphs/blackbear_raccoon_low.pdf")
...
pdf("results/overlap_graphs/blackbear_raccoon_high.pdf")
...
# t = -99.401, df = 398, p-value < 2.2e-16
