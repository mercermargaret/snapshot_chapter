# Black Bear and Opossum Overlap Analysis
# Margaret Mercer
# May 21, 2024
...
pdf("results/overlap_graphs/blackbear_opossum_low.pdf")
...
pdf("results/overlap_graphs/blackbear_opossum_high.pdf")
...
# t = -140.43, df = 398, p-value < 2.2e-16
