...
pair <- filter(df_inside, Species_Name == 'Canis lupus' | Species_Name == 'Alces alces')
...
# data:  bootstrap_low and bootstrap_high
# t = 7.4996, df = 398, p-value = 4.209e-13
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.03000451 0.05132394
# sample estimates:
#   mean of x mean of y 
# 0.7741496 0.7334853
...
# data:  bootstrap_low and bootstrap_high
# t = 7.197, df = 398, p-value = 3.087e-12
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.02719237 0.04763131
# sample estimates:
#   mean of x mean of y 
# 0.7738683 0.7364564
