# Grizzly and Skunk Overlap Analysis
# Margaret Mercer
# May 21, 2024
...
pdf("results/overlap_graphs/grizzly_skunk_low.pdf")
...
pdf("results/overlap_graphs/grizzly_skunk_high.pdf")
...
# t = -44.843, df = 398, p-value < 2.2e-16
