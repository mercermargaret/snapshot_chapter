# Grizzly and Raccoon Overlap Analysis
# Margaret Mercer
# May 21, 2024
...
pdf("results/overlap_graphs/grizzly_raccoon_low.pdf")
...
pdf("results/overlap_graphs/grizzly_raccoon_high.pdf")
...
# t = -8.2246, df = 398, p-value = 2.808e-15
