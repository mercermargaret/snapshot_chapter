# Puma and Bobcat Overlap Analysis
# Margaret Mercer
# May 21, 2024
...
# get range data
prey_range <- st_read('data/subset_shape_files/Bobcat')
...
pair <- filter(df_inside, Species_Name == 'Puma concolor' | Species_Name == 'Lynx rufus') 
...
pdf("results/overlap_graphs/puma_bobcat_low.pdf")
...
pdf("results/overlap_graphs/puma_bobcat_high.pdf")
...
# t = -8.262, df = 398, p-value = 2.15e-15
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.04368538 -0.02689160
# sample estimates:
#   mean of x mean of y 
# 0.8009644 0.8362529
...
# data:  bootstrap_low and bootstrap_high
# t = 8.9279, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.02832694 0.04432516
# sample estimates:
#   mean of x mean of y 
# 0.8415145 0.8051884
