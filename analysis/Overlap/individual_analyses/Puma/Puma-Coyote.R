# Puma and Coyote Overlap Analysis
# Margaret Mercer
# May 24, 2024
...
# get range data
prey_range <- st_read('data/subset_shape_files/Coyote')
...
pair <- filter(df_inside, Species_Name == 'Puma concolor' | Species_Name == 'Canis latrans') 
...
low_prey <- time_radians[low_dist$Species_Name == 'Canis latrans']

pdf("results/overlap_graphs/puma_coyote_low.pdf")
...
high_prey <- time_radians[high_dist$Species_Name == 'Canis latrans']

pdf("results/overlap_graphs/puma_coyote_high.pdf")
...
# t test with cutoff at median of pairing
# data:  bootstrap_low and bootstrap_high
# t = 1.2998, df = 398, p-value = 0.1944
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.00232581  0.01140265
# sample estimates:
#   mean of x mean of y 
# 0.8296834 0.8251450
