# Puma and Raccoon Overlap Analysis
# Margaret Mercer
# May 21, 2024
...
# get range data
prey_range <- st_read('data/subset_shape_files/Raccoon')
...
pair <- filter(df_inside, Species_Name == 'Puma concolor' | Species_Name == 'Procyon lotor') 
...
low_prey <- time_radians[low_dist$Species_Name == 'Procyon lotor']

pdf("results/overlap_graphs/puma_raccoon_low.pdf")
...
high_prey <- time_radians[high_dist$Species_Name == 'Procyon lotor']

pdf("results/overlap_graphs/puma_raccoon_high.pdf")
...
# t = -30.885, df = 398, p-value < 2.2e-16
...
# data:  bootstrap_low and bootstrap_high
# t = -8.4488, df = 398, p-value = 5.596e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.06818583 -0.04244353
# sample estimates:
#   mean of x mean of y 
# 0.6350956 0.6904103