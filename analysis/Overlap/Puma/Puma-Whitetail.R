...
pair <- filter(df_inside, Species_Name == 'Puma concolor' | Species_Name == 'Odocoileus virginianus') 
...
# t test with cutoff median
# data:  bootstrap_low and bootstrap_high
# t = -14.434, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.05836759 -0.04437395
# sample estimates:
#   mean of x mean of y 
# 0.8157025 0.8670733

# t test with cutoff median of pair
# data:  bootstrap_low and bootstrap_high
# t = 1.7566, df = 398, p-value = 0.07975
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.0008185651  0.0145563606
# sample estimates:
#   mean of x mean of y 
# 0.8153583 0.8084894 
