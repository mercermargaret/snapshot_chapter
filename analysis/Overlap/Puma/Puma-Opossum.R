# Puma and Opossum Overlap Analysis
# Margaret Mercer
# May 21, 2024
...
# get range data
prey_range <- st_read('data/subset_shape_files/Opossum')
...
pair <- filter(df_inside, Species_Name == 'Puma concolor' | Species_Name == 'Didelphis virginiana') 
...
low_prey <- time_radians[low_dist$Species_Name == 'Didelphis virginiana']

pdf("results/overlap_graphs/puma_opossum_low.pdf")
...
high_prey <- time_radians[high_dist$Species_Name == 'Didelphis virginiana']

pdf("results/overlap_graphs/puma_opossum_high.pdf")
...
# t = -0.92835, df = 390, p-value = 0.3538
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.04375567  0.01568746
# sample estimates:
#   mean of x mean of y 
# 0.3995183 0.4135524 
...
# data:  bootstrap_low and bootstrap_high
# t = 6.1813, df = 369, p-value = 1.684e-09
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.06899334 0.13336892
# sample estimates:
#   mean of x mean of y 
# 0.4302460 0.3290649
