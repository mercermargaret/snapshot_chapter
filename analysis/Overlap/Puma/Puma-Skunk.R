# Puma and Skunk Overlap Analysis
# Margaret Mercer
# May 21, 2024
...
pair <- filter(df_inside, Species_Name == 'Puma concolor' | Species_Name == 'Mephitis mephitis') 
...
pdf("results/overlap_graphs/puma_skunk_low.pdf")
...
pdf("results/overlap_graphs/puma_skunk_high.pdf")
...
# ata:  bootstrap_low and bootstrap_high
# t = -39.269, df = 398, p-value < 2.2e-16
...
# t = -59.104, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.2355243 -0.2203604
# sample estimates:
