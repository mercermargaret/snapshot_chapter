...
# Black bear: shift toward later in the evening with higher human activity
# Elk: more diurnal with higher human activity!
# Overlap t test: sliiightly more overlap with high human activity than low


# Print results to "results" folder ####

# overlap graph
pdf("results/overlap_graphs/blackbear_elk_low.pdf")
overlapPlot(low_pred, low_prey)
legend('topright', c("Black Bear", "Elk"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()

pdf("results/overlap_graphs/blackbear_elk_high.pdf")
overlapPlot(high_pred, high_prey)
legend('topright', c("Black Bear", "Elk"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()
...
# t = 2.0049, df = 398, p-value = 0.04565
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.0001334253 0.0135987033
# sample estimates:
#   mean of x mean of y 
# 0.7944999 0.7876338
...
# cutoff at median
# data:  bootstrap_low and bootstrap_high
# t = -8.7786, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.03279434 -0.02079352
# sample estimates:
#   mean of x mean of y 
# 0.7972355 0.8240294 
