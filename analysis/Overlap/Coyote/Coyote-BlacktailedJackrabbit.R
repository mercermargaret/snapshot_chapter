# Coyote and Blacktailed Jackrabbit Overlap Analysis
# Margaret Mercer
# May 1, 2024
...
# get range data
prey_range <- st_read('data/subset_shape_files/Blacktailed Jackrabbit')
...
low_prey <- time_radians[low_dist$Species_Name == 'Lepus californicus']
...
high_prey <- time_radians[high_dist$Species_Name == 'Lepus californicus']
...
# Coyote: not much of a shift
# Blacktailed Jackrabbit: extremely higher peak at 6am with higher human presence
...
# overlap graph
pdf("results/overlap_graphs/coyote_blackjackrabbit_low.pdf")
overlapPlot(low_pred, low_prey)
legend('topright', c("Coyote", "Blacktailed Jackrabbit"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()

pdf("results/overlap_graphs/coyote_blackjackrabbit_high.pdf")
overlapPlot(high_pred, high_prey)
legend('topright', c("Coyote", "Blacktailed Jackrabbit"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()
...
# t = 7.4646, df = 398, p-value = 5.314e-13
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.01122689 0.01925476
# sample estimates:
#   mean of x mean of y 
# 0.8113670 0.7961262 
...
# cutoff at median
# data:  bootstrap_low and bootstrap_high
# t = -5.2503, df = 398, p-value = 2.477e-07
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.012679372 -0.005770857
# sample estimates:
#   mean of x mean of y 
# 0.8187886 0.8280137 
