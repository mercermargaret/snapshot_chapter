# Grizzly and Mule Deer Overlap Analysis
# Margaret Mercer
# April 16, 2024
...
# Grizzly: clear shift toward noct with higher human presence
# Mule deer: maybe sliiightly more noct with higher human presence
# Overlap:  higher with low human dist than high
...
# overlap graph
pdf("results/overlap_graphs/grizzly_muledeer_low.pdf")
overlapPlot(low_pred, low_prey)
legend('topright', c("Grizzly", "Mule Deer"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()

pdf("results/overlap_graphs/grizzly_muledeer_high.pdf")
overlapPlot(high_pred, high_prey)
legend('topright', c("Grizzly", "Mule Deer"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()
...
# FIRST run: (before standardizing shape files) OBSELETE?
# data:  bootstrap_low and bootstrap_high
# t = 2.5187, df = 398, p-value = 0.01217
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.003295698 0.026737927
# sample estimates:
#   mean of x mean of y 
# 0.5667562 0.5517394 
...
# subsequent runs
# data:  bootstrap_low and bootstrap_high
# t = 25.8, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.06778468 0.07896719
# sample estimates:
#   mean of x mean of y 
# 0.7220213 0.6486453

# data:  bootstrap_low and bootstrap_high
# t = 24.244, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.06858126 0.08068530
# sample estimates:
#   mean of x mean of y 
# 0.7229036 0.6482703 

# data:  bootstrap_low and bootstrap_high
# t = 25.509, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.06806141 0.07942832
# sample estimates:
#   mean of x mean of y 
# 0.7220281 0.6482833 
...
# data:  bootstrap_low and bootstrap_high
# t = 31.636, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.08036362 0.09101333
# sample estimates:
#   mean of x mean of y 
# 0.7187016 0.6330132
