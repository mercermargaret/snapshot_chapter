# Grizzly and Whitetail Overlap Analysis
# Margaret Mercer
# April 16, 2024
...
# Grizzly: more noct with human presence
# Whitetail: more nocturnal with higher human presence
# Overlap: Higher in areas of LOWER human disturbance (p < 0.01)


# Print results to "results" folder ####

# overlap graph
pdf("results/overlap_graphs/grizzly_whitetail_low.pdf")
overlapPlot(low_pred, low_prey)
legend('topright', c("Grizzly", "Whitetail"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()

pdf("results/overlap_graphs/grizzly_whitetail_high.pdf")
overlapPlot(high_pred, high_prey)
legend('topright', c("Grizzly", "Whitetail"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()
...
# t = -7.8995, df = 398, p-value = 2.764e-14
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.06506759 -0.03913479
# sample estimates:
#   mean of x mean of y 
# 0.6163087 0.6684099 
...
# Subsequent runs:
# data:  bootstrap_low and bootstrap_high
# t = 18.79, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.06557492 0.08090043
# sample estimates:
#   mean of x mean of y 
# 0.7714121 0.6981744 

# data:  bootstrap_low and bootstrap_high
# t = 20.407, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.07179990 0.08710861
# sample estimates:
#   mean of x mean of y 
# 0.7721420 0.6926878 

# data:  bootstrap_low and bootstrap_high
# t = 19.332, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.06594877 0.08088024
# sample estimates:
#   mean of x mean of y 
# 0.7713924 0.6979779
...
# data:  bootstrap_low and bootstrap_high
# t = 21.237, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.07487607 0.09015322
# sample estimates:
#   mean of x mean of y 
# 0.7660526 0.6835379