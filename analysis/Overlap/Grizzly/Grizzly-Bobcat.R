# Grizzly and Bobcat Overlap Analysis
# Margaret Mercer
# May 21, 2024
...
pdf("results/overlap_graphs/grizzly_bobcat_low.pdf")
...
pdf("results/overlap_graphs/grizzly_bobcat_high.pdf")
...
# t = 12.868, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.04843398 0.06590249
# sample estimates:
#   mean of x mean of y 
# 0.7662737 0.7091054
