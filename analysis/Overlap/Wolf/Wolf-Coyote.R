# Wolf and Coyote Overlap Analysis
# Margaret Mercer
# May 29, 2024
...
pair <- filter(df_inside, Species_Name == 'Canis lupus' | Species_Name == 'Canis latrans')
...
pdf("results/overlap_graphs/wolf_coyote_low.pdf")
...
pdf("results/overlap_graphs/wolf_coyote_high.pdf")
...
# t = 6.5014, df = 398, p-value = 2.387e-10
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.01716699 0.03204950
# sample estimates:
#   mean of x mean of y 
# 0.8541220 0.8295137