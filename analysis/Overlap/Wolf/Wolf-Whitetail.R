...
# overlap graph
pdf("results/overlap_graphs/wolf_whitetail_low.pdf")
overlapPlot(low_pred, low_prey)
legend('topright', c("Wolf", "Whitetail"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()

pdf("results/overlap_graphs/wolf_whitetail_high.pdf")
overlapPlot(high_pred, high_prey)
legend('topright', c("Wolf", "Whitetail"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()
...
# t = 19.18, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.07071664 0.08686881
# sample estimates:
#   mean of x mean of y 
# 0.8649867 0.7861940 
...
# second t test
# data:  bootstrap_low and bootstrap_high
# t = 19.053, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.07098165 0.08731497
# sample estimates:
#   mean of x mean of y 
# 0.8652743 0.7861260 
