...
# Black bear: Become more nocturnal with higher human presence
# Whitetails: a tiiiiiiny bit more nocturnal with higher human presence
...
# overlap graph
pdf("results/overlap_graphs/blackbear_whitetail_low.pdf")
overlapPlot(low_pred, low_prey)
legend('topright', c("Black Bear", "Whitetail"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()

pdf("results/overlap_graphs/blackbear_whitetail_high.pdf")
overlapPlot(high_pred, high_prey)
legend('topright', c("Black Bear", "Whitetail"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()
...
# t = -33.955, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.04095641 -0.03647339
# sample estimates:
#   mean of x mean of y 
# 0.8263222 0.8650371 
...
# data:  bootstrap_low and bootstrap_high
# t = -32.271, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.03786834 -0.03351945
# sample estimates:
#   mean of x mean of y 
# 0.8289187 0.8646126
