...
pair <- filter(df_inside, Species_Name == 'Canis lupus' | Species_Name == 'Cervus canadensis')
...
# Elk: evening peak much higher in high human presence than low. More day activity in higher human activity
...
# overlap graph
pdf("results/overlap_graphs/wolf_elk_low.pdf")
overlapPlot(low_pred, low_prey)
legend('topright', c("Wolf", "Elk"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()

pdf("results/overlap_graphs/wolf_elk_high.pdf")
overlapPlot(high_pred, high_prey)
legend('topright', c("Wolf", "Elk"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()
...
# t = 9.4736, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.04532672 0.06906507
# sample estimates:
#   mean of x mean of y 
# 0.7747034 0.7175075
...
# second t test
# data:  bootstrap_low and bootstrap_high
# t = 8.1269, df = 398, p-value = 5.619e-15
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   0.03550931 0.05817102
# sample estimates:
#   mean of x mean of y 
# 0.7708709 0.7240308

# with cutoff set to median of pairing
# data:  bootstrap_low and bootstrap_high
# t = -7.368, df = 398, p-value = 1.009e-12
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.06360876 -0.03681382
# sample estimates:
#   mean of x mean of y 
# 0.6925025 0.7427138