# Coyote and Mule Deer Overlap Analysis
# Margaret Mercer
# April 30, 2024
...
# Coyote: goes from more consistent activity with low human presence to strong crepuscular peaks during high human presence
# Mule Deer: mayyyybe sliiiight shift toward noct with higher human presence?
# Overlap: more overlap with high than low human presence


# Print results to "results" folder ####

# overlap graph
pdf("results/overlap_graphs/coyote_muledeer_low.pdf")
overlapPlot(low_pred, low_prey)
legend('topright', c("Coyote", "Mule Deer"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()

pdf("results/overlap_graphs/coyote_muledeer_high.pdf")
overlapPlot(high_pred, high_prey)
legend('topright', c("Coyote", "Mule Deer"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()
...
# t = -68.189, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.07535141 -0.07112828
# sample estimates:
#   mean of x mean of y 
# 0.7962378 0.8694777 
...
# cutoff at median
# data:  bootstrap_low and bootstrap_high
# t = -66.883, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.07243301 -0.06829643
# sample estimates:
#   mean of x mean of y 
# 0.7970944 0.8674591 
