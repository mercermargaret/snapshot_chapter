# Cottontail and Human Overlap Analysis
# Margaret Mercer
# May 9, 2024
...
low_animal <- time_radians[low_dist$Species_Name == 'Sylvilagus aquaticus' |
...
pdf("results/overlap_graphs/cottontail_human_low.pdf")
overlapPlot(low_animal, low_human)
legend('topright', c("Cottontail", "Human"), lty=c(1,2), col=c(1,4), bty='n')
dev.off()
...
high_animal <- time_radians[high_dist$Species_Name == 'Sylvilagus aquaticus' |
...
pdf("results/overlap_graphs/cottontail_human_high.pdf")
...
# Cottontail: sliiight shift toward diurnality with higher human presence. Higher AM crepuscular peak with higher human presence
# Human: wider spread with higher human activity
# Overlap: increasing slightly with higher human activity

# t test results
# data:  bootstrap_low and bootstrap_high
# t = -147.33, df = 398, p-value < 2.2e-16
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.06964269 -0.06780853
# sample estimates:
#   mean of x mean of y 
# 0.2040504 0.2727760 