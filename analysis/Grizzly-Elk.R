...
# same error as Blackbear-Whitetail is occurring, when if spherical geometry is on, it breaks, but if it's off, it loads forever and doesn't ever finish
...
# Grizzly: shift toward noct with high human presence
# Elk: shift toward diurnality with high human presence
