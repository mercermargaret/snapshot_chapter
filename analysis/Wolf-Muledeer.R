...
range_overlap <- st_intersection(prey_range_unified, pred_range_unified)
...
# Mule deer: with high human disturbance, a bit more diunral activity and a MUCH higher peak in the evening than in morning (whereas with low, peaks are same height)
# Overlap in high vs low: overlap greater in higher human disturbance areas than in lower, but not by much (p = 0.123)
