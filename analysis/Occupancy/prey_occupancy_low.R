...
write.csv(hist, "data/hist_low_prey.csv")
write.csv(DOY, "data/DOY_low_prey.csv")
write.csv(survey_days, "data/survey_days_low_prey.csv")
...
hist <- read.csv("data/hist_low_prey.csv")
DOY <- read.csv("data/DOY_low_prey.csv")
survey_days <- read.csv("data/survey_days_low_prey.csv")
site_info <- read.csv("data/site_info_low_prey.csv") # we made this in the "predator_occupancy_low" file
