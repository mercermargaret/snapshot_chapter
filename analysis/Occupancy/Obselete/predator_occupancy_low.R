...
# (pull out value to use as covariate for low prey occupancy)
# margaret mercer
# august 5, 2024
...
write.csv(hist, "data/hist_low_pred.csv")
write.csv(DOY, "data/DOY_low_pred.csv")
write.csv(survey_days, "data/survey_days_low_pred.csv")
write.csv(site_info, "data/site_info_low_pred.csv")
...
hist <- read.csv("data/hist_low_pred.csv")
DOY <- read.csv("data/DOY_low_pred.csv")
survey_days <- read.csv("data/survey_days_low_pred.csv")
site_info <- read.csv("data/site_info_low_pred.csv")
...
write_csv(site_info, "data/site_info_low_prey.csv")
