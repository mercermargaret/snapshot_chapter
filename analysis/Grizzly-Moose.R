...
# BROKEN (see "FIXGRIZZLYMOOSEBUGx_x document)
...
# cut out right half of mule deer range because there's a point there causing problems when we try to get overlap
